    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-bold text-xl bg-gradient-to-r from-primary to-violet-500 bg-clip-text text-transparent">
              Studify
            </span>
          </div>
          <div className="flex items-center gap-3">
      ...
      <section className="relative pt-32 pb-24 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          >
            O Studify transforma disciplina em hábito. Crie grupos com seus
            colegas, registre cada sessão de estudo e mantenha todos na trilha
            com ranking e streak em tempo real.
          </motion.p>
          ...
          <div className="rounded-2xl border border-border/60 bg-card shadow-2xl shadow-primary/5 overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="rounded-xl border border-border/50 bg-background p-3 text-center"
                >
                  ...
                  <div className="mt-2 flex items-center justify-center gap-1">
                    <span
                      className={`text-xs font-bold ${i === 0 ? "text-primary" : "text-muted-foreground"}`}
                    >
                      {user.hours}
                    </span>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              Três passos para transformar sua rotina de estudos
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="absolute top-4 right-4 text-5xl font-black text-border/40 select-none">
                  {item.step}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-5xl font-bold mb-6">
                Por que o Studify funciona
              </h2>
              <p className="text-muted-foreground text-lg mb-8">
                A psicologia do comprometimento público e da competição saudável
                ...
                {[
                  {
                    ...
                    desc: "O streak diário te responsabiliza mesmo quando a motivação cai.",
                  },
                  {
                    icon: <Users className="h-5 w-5 text-violet-500" />,
                    title: "Pressão social positiva",
                    desc: "Ver seus colegas estudando te impulsiona a não ficar para trás.",
                  },
                  {
                    icon: <TrendingUp className="h-5 w-5 text-green-500" />,
                    title: "Progresso visível",
                    desc: "Ranking semanal e histórico de horas mostram sua evolução real.",
                  },
                ].map((b, i) => (
                  <motion.div
                    key={i}
            ...
            >
              {[
                {
                  user: "Maria K.",
                  text: "Sem o Studify eu estudava 1 hora por semana no máximo. Agora são 15+ horas com consistência.",
                  streak: 14,
                },
                {
                  user: "Pedro A.",
                  text: "O ranking semanal me fez estudar até nos fins de semana. A competição saudável funciona mesmo.",
                  streak: 21,
                },
                {
                  user: "Carla T.",
                  text: "Criei um grupo para o concurso e todos passamos. A responsabilidade coletiva fez toda diferença.",
                  streak: 30,
                },
              ].map((t, i) => (
                <div
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-10">
              Crie sua conta gratuitamente e convide seus colegas. Em menos de 2
              minutos você tem seu grupo de estudos funcionando.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/">
                <Button
                  size="lg"
                  className="gap-2 shadow-xl shadow-primary/20 w-full sm:w-auto"
                >
      ...
      <footer className="border-t border-border/50 py-8 px-4 sm:px-6">
        <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-muted-foreground">
            © 2025 Studify. Feito para quem estuda de verdade.
          </p>
        </div>
      </footer>
    </div>
